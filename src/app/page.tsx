...
const jsonLd = [
  {
    ...
    featureList: [
      'Planning Gantt et calendrier',
      'Plan d’action avec matrice RACI intégrée',
      'AMDEC : cotation de la criticité et actions correctives tracées',
      'Suivi des coûts prévu vs réel',
      'Reporting de revue de projet et charte A3 générés automatiquement',
      'Résolution de problèmes : Ishikawa, 5 Pourquoi, PDCA, SWOT',
      'Collaboration en temps réel',
    ],
    audience: {
      '@type': 'BusinessAudience',
      name: 'Chefs de projet, responsables méthodes et industrialisation — PME et ETI industrielles',
    },
    offers: { '@type': 'Offer', price: '0', priceCurrency: 'EUR', description: 'Essai gratuit 14 jours' },
    publisher: { '@id': 'https://projetentan.fr/#organization' },
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Organization',
    '@id': 'https://projetentan.fr/#organization',
    name: 'ENTAN',
    alternateName: 'Projet Entan',
    url: 'https://projetentan.fr',
    logo: 'https://projetentan.fr/entan-logo.png',
    description:
      'Startup française éditrice d’ENTAN, le logiciel de gestion de projet pour l’industrie.',
  },
  {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
