...
import { memberName, useCurrentProject, useProjectActions } from '../../store/useStore';
...
export function PlanningPage() {
  ...
  return (
    <div className="page">
      ...
      {view === 'calendar' && <CalendarView actions={filtered} onSelect={setEditing} responsibleName={memberFor} />}
      {view === 'gantt' && (
