...
export const TOOL_ORDER: ToolId[] = ['raci', 'amdec', 'actions', 'planning', 'revue', 'rdp', 'liens', 'couts', 'a3', 'swot'];
...
export const TOOLS: Record<ToolId, ToolDef> = {
  ...
  rdp: { id: 'rdp', label: 'Résolution de problèmes', href: '/rdp', description: 'Démarche en 7 phases (sujet, QQOQCP, Ishikawa 5M, solutions, PDCA) — plusieurs résolutions possibles par projet.' },
